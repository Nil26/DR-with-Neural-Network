...
w4 = theano.shared(np.transpose(ini_value_w3), name="w4")
w5 = theano.shared(np.transpose(ini_value_w2), name="w5")
w6 = theano.shared(np.transpose(ini_value_w1), name="w6")
...
step1_result = T.dot(T.transpose(w1),data) + b1 > 0
...
train = theano.function(
          inputs=[data],
          outputs=[cost, b1, b2, b3, b4, b5, b6, w1, w2, w3],
...
for i in range(training_steps):
	print("iteration:",i)
	cost, b1, b2, b3, b4, b5, b6, w1, w2, w3 = train(simulate_data)
